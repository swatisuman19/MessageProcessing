 ...
 * @author swati
 *
 *         Stores information about the sale notifications and any logs any sale
 *         adjustments made to products. Provides a reporting table on every
 *         10th notice record and stops accepting any sales notice after 50
 *         message. The adjustment reports are shown after the 50th message.
 *
 */
